...
if __name__ == '__main__':
    ...
    sigma_int_for_naming = sigma_int[0]    
    
    # remove redshift_bin folder?! --> this would create super-long folder-names for more than 3 zbins...
    #if nzbins > 1:
    path_output = ini.root_run + '/sigma_int{:.2f}/{:.2f}z{:.2f}/{:}zbins/'.format(sigma_int_for_naming, z_min, z_max, nzbins) + '/' + ini.identifier_in + '/'
    path_store = ini.root_store + '/sigma_int{:.2f}/{:.2f}z{:.2f}/{:}zbins/'.format(sigma_int_for_naming, z_min, z_max, nzbins) + '/' + ini.identifier_in + '/'        
    ...
    '''
        ...
        path_output = ini.root_run + '/sigma_int{:.2f}/{:.2f}z{:.2f}/'.format(sigma_int_for_naming, z_min, z_max) + '/' + ini.identifier_in + '/'
        path_store = ini.root_store + '/sigma_int{:.2f}/{:.2f}z{:.2f}/'.format(sigma_int_for_naming, z_min, z_max) + '/' + ini.identifier_in + '/'        
